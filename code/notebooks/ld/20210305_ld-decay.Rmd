...
```{bash, eval = F}
# Run on cluster because the files are so big
script=code/scripts/ld_decay/20210305_maf_plot.R
in_mikk=../maf/20200727_mikk_no-missing.frq
in_1kg=../maf/20200727_1kg_no-missing.frq
out_file=plots/ld_decay/20210305_maf_MIKKv1KG

Rscript --vanilla $script $in_mikk $in_1kg $out_file
```

```{r, echo = F}
knitr::include_graphics(here::here("plots", "ld_decay", "20210305_maf_MIKKv1KG.svg"))
```
