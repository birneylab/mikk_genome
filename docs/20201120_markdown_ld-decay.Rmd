...
![**14_12490842-12947083**](hv_14_12490842-12947083.png)
![**17:15557892-19561518**](hv_17_15557892-19561518.png)

![**21:6710074-7880374**](hv_21_6710074-7880374.png)
...
read_n_bind = function(dataset){
  # Set path
  path = paste("ld/20200727_mean_r2_10kb-lim_", dataset, sep = "")
...
datasets = c("mikk", "1kg")
final_lst = lapply(datasets, read_n_bind)
