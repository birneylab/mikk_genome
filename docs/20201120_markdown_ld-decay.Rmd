...
script=mikk_genome/code/scripts/20200727_maf_plot.R
in_mikk=maf/20200727_mikk_no-missing.frq
in_1kg=maf/20200727_1kg_no-missing.frq
out_dir=mikk_genome/plots
out_file=20200727_maf_MIKKv1KG

Rscript --vanilla $script $in_mikk $in_1kg $out_dir $out_file
```

```{r, echo = F}
knitr::include_graphics("20200727_maf_MIKKv1KG.png")
```
