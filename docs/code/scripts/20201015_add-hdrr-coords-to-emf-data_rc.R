...
file_data <- paste(file_in, "_1_rc.data.txt", sep = "")
file_tree <- paste(file_in, "_-1.tree.txt", sep = "")
file_seq <- paste(file_in, "_-1.seq.txt", sep = "")
...
bname_out <- paste(basename(file_in), "_rc.txt", sep = "")
