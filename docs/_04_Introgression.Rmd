...
saveRDS(ol_ranges_list, "/nfs/research/birney/users/ian/mikk_genome/introgression/hni_hsok_range.rds")
```

```{r, include = F}
ol_ranges_list = readRDS("/nfs/research/birney/users/ian/mikk_genome/introgression/hni_hsok_range.rds")
```
...
```{r, eval = F, include = F}
# Save to speed up when rendering HTML
saveRDS(mikk_ranges, "/nfs/research/birney/users/ian/mikk_genome/introgression/mikk.txt.gz")
```

```{r, include = F}
mikk_ranges = readRDS("/nfs/research/birney/users/ian/mikk_genome/introgression/mikk.txt.gz")
```
...
```{r, eval = F, include = F}
# Save to speed up when rendering HTML
saveRDS(ex_ranges, "/nfs/research/birney/users/ian/mikk_genome/introgression/ex_range.rds")
```

```{r, include = F}
ex_ranges = readRDS("/nfs/research/birney/users/ian/mikk_genome/introgression/ex_range.rds")
```
...
```{r}
out_plot = here::here("docs/plots/introgression/20210427_introgression_circos_MIKK_ABBA_p1-hdrr.png")
```
...
```
```{r}
out_plot = here::here("docs/plots/introgression/20210427_introgression_circos_MIKK_ABBA_p1-icab.png")
```
...
```{r}
out_plot = here::here("docs/plots/introgression/20210505_introgression_circos_MIKK_ABBA_p1-hdrr.png")
```
